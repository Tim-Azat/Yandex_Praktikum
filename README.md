...
:--|:------------------:|:------------:|:---------
1 |	Выявление потенциально популярных продуктов	| На основе исторических данных выявить определяющие успешность игры закономерности |	Python, Pandas, Matplotlib, Seaborn, Pivot_table, Groupby, Scipy.stats
